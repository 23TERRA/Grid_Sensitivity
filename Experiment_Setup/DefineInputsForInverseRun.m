...
% I already take good area of the data missing, especially for the rift
% area in front the of the Amery Shelf, such as: 
% Ameryvelocityfu(rift) = 0; AmeryVeloErr(rift) = 1e4;
