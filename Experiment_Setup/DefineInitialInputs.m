...
%%
Interpolant_path='...\GridSensitivity';
UserVar.GeometryInterpolant=fullfile(Interpolant_path, 'AmeryGeometryInterpolantWQX_BMAV3.mat');                       
UserVar.SurfaceVelocityInterpolant=fullfile(Interpolant_path, 'AmeryVelocityInterpolantWQX.mat');
UserVar.BoundaryShp =fullfile(Interpolant_path, 'Amery2023.shp');
...
CtrlVar.SaveInitialMeshFileName='WQXMesh2km.mat';
...
CtrlVar.SaveAdaptMeshFileName='Mesh2km';    %  file name for saving adapt mesh. If left empty, no file is written
...
CtrlVar.Inverse.Regularize.logC.gs=1e3*gamafactor;
...
CtrlVar.Inverse.Regularize.logAGlen.gs=1e3*gamafactor;
